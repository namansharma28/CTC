...
export default function AdminUsersPage() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch(`/api/admin/users?page=${page}&limit=${pageSize}&search=${debouncedSearchQuery}`, {
        headers: {
          'Authorization': `Bearer ${adminToken}`
        }
      });
  ...
  }, [page, debouncedSearchQuery, isAdmin]);
  ...
  const canPromoteToOperator = (currentUserRole: UserRole): boolean => {
    // Only admin can promote to operator
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  {canPromoteToOperator('admin') && (
                    <SelectItem value="operator">Operator</SelectItem>
                  )}
                  {/* Only super admin can promote to admin, not implemented here */}
                </SelectContent>
              </Select>
            </div>
          </div>
